#!/bin/bash
# Build and push Product Reviews service to Docker Hub
SERVICE_NAME="product-reviews-svc"
...
kubectl rollout restart deployment product-reviews-service -n services
